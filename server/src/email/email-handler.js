...
exports.sendEmail = async(email_address, uuid) => {
  ...
  const body = `
    ...
    <p>Click 
    <a href=${registration_url}>here<a/>
     to create your account and finish the registration process</p>`;

  const text = `Go to ${registration_url} 
  to create your account and finish the registration process`;
